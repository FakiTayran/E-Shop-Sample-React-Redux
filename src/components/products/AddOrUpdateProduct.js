...
const AddOrUpdateProduct = ({ products, categories, getProducts, getCategories, saveProduct, history, ...props }) => {
    ...
    function validate(name,value) {
        if (name="productName" && value == "") {
            setErrors(previousErrors => ({
                ...previousErrors, productName: "Product name must be written"
            }));
        }else{
            setErrors(previousErrors => ({
